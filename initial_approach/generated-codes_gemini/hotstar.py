...
if __name__ == '__main__':
    ...
    dotenv.load_dotenv()
    x_hs_user_token = os.getenv("X-HS-USERTOKEN")
    x_hs_device_id = os.getenv("X-HS-DEVICE-ID")

    USER_TOKEN = f"{x_hs_user_token}"  # e.g., "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..."
    DEVICE_ID = f"{x_hs_device_id}"   # e.g., "219a06-92f4d3-3cf707-a5941"

    print("--- Debugging Environment Variables ---")
    print(f"Loaded Token: {USER_TOKEN}")
